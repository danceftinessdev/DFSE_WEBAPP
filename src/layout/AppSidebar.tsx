...
const othersItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Jelvények", path: "/admin/badge", pro: false },
      { name: "Gombok", path: "/admin/buttons", pro: false },
      { name: "Képek", path: "/admin/images", pro: false },
      { name: "Modal ablakok", path: "/admin/modals", pro: false },
      { name: "Videók", path: "/admin/videos", pro: false },
    ],
  },
  {
    name: "Egyéb oldalak",
